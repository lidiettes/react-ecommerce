    ...
    return (
        <>
            <div className="news__container">
                ...
                <p className='pNews'>Hee Welling (born 1974) is an award-winning furniture designer. In addition to being exhibited at fairs and museums worldwide, his products can be found in a diverse array of interiors, from The Oslo Opera House to Australia’s parliament.
